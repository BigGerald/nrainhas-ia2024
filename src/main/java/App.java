...
public class App {
    public static void main(String[] args) {
        ...
        PermFunctionIndFactory permFactory = new PermFunctionIndFactory(nGenes);
        LangermannFunctionIndFactory langermannFactory = new LangermannFunctionIndFactory(nVar);
        DixonPriceFunctionIndFactory dixonPricedFactory = new DixonPriceFunctionIndFactory(nGenes);
